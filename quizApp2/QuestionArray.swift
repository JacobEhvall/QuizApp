...
class QuestionArray {
    ...
    init() {
        ...
        let q18 = Question(image: "DuckHunt", questionText: "Before SEGA was marketing their Mega Drive console in public the in-house name was?", answers:[ "M8-1541","M7-1833","MK-1601","MK-1221"], correct: 2)
        questionsSEGA.append(q18)
        let q19 = Question(image: "DuckHunt", questionText: "What´s the abbrevation for the SEGA name?", answers:[ "SErive GAmes","SElectic GAmes","SElected GAmes","SEgue GAmes"], correct: 0)
